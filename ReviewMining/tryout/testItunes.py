...
def tryNewRanking(ranked_bnss, aux_info):
    ...
    for bnss_key, timeWindow in ranked_bnss:
        ...
        # except:
        #     print idx1, idx2, len(statistics_for_bnss[StatConstants.NON_CUM_NO_OF_REVIEWS]), \
        #         [statistics_for_bnss[StatConstants.NON_CUM_NO_OF_REVIEWS][idx]
        #                        for idx in range(idx1, idx2)
        #                        if idx2 < len(statistics_for_bnss[StatConstants.NON_CUM_NO_OF_REVIEWS])]
        #     raise
...
if __name__ == "__main__":
    ...
    # bnss_list =3                                                                                                                                                                                                                                                                       AppUtil.extractAndSerializeBnssStatisticsForBnss(csvFolder, plotDir,
